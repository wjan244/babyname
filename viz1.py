...
scatter = (
    ...
    .transform_calculate(x_val="datum[x_param]", y_val="log_y_param ? log(datum[y_param]) : datum[y_param]")
    .add_params(x_param, y_param, log_y_param, brush_interval, brush_point)
